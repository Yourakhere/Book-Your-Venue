...
const LandingPage = () => {
  ...
  const handleLogin = () => {
    navigate('/login'); // Navigate to login page or open login modal
  };
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="space-y-4">
                  <div className="bg-white rounded-2xl shadow-xl p-4 transform rotate-3 hover:rotate-0 transition-transform duration-300">
                    <div className="bg-gradient-to-br from-blue-100 to-indigo-100 h-32 rounded-lg mb-3"></div>
                  ...
                  <div className="bg-white rounded-2xl shadow-xl p-4 transform -rotate-2 hover:rotate-0 transition-transform duration-300">
                    <div className="bg-gradient-to-br from-purple-100 to-pink-100 h-32 rounded-lg mb-3"></div>
                ...
                <div className="space-y-4 mt-8">
                  <div className="bg-white rounded-2xl shadow-xl p-4 transform -rotate-3 hover:rotate-0 transition-transform duration-300">
                    <div className="bg-gradient-to-br from-green-100 to-teal-100 h-32 rounded-lg mb-3"></div>
                  ...
                  <div className="bg-white rounded-2xl shadow-xl p-4 transform rotate-2 hover:rotate-0 transition-transform duration-300">
                    <div className="bg-gradient-to-br from-orange-100 to-red-100 h-32 rounded-lg mb-3"></div>
